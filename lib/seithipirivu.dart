// ignore_for_file: prefer_const_constructors, prefer_const_literals_to_create_immutables, avoid_unnecessary_containers, prefer_typing_uninitialized_variables, avoid_print, unused_import, unnecessary_import, sized_box_for_whitespace, deprecated_member_use, must_be_immutable
...
class _NewsSectionState extends State<NewsSection> {
  ...
  void _incrementCounter() {
    setState(() {
      if (widget.jsonList.length > intvalue) {
        intvalue = intvalue + 5;
      }
    });
  }
                  ...
                  Container(
                    ...
                    child: Row(
                        ...
                        children: [
                          ...
                          Text(widget.relatednewsjsonList["posts"]
                              [widget.authorindex]["author"]["name"])
                        ]),
                  ),
                  Divider(
                    color: Colors.grey,
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (widget.relatednewsjsonList["posts"]
                                [widget.authorindex]["author"]["name"] ==
                            widget.relatednewsjsonList["posts"][index]["author"]
                                ["name"]) {
                          return InkWell(
                            onTap: () {
                              Navigator.push(
